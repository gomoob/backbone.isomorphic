...
module.exports = function(search, replacement, options) {
  ...
  var replaceWithFile = function(str, replacementCb, file) {
      return str.replace(search, function(val) {
          return replacementCb(val, file);
      });
  };
    ...
    function doReplace() {
      ...
      if (file.isBuffer()) {
        if (search instanceof RegExp) {
          file.contents = new Buffer(replaceWithFile(String(file.contents), replacement, file));
        }
        else {
